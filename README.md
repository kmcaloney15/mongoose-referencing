...
> Note. All forms/views and controller actions that relied on the cast being an array of strings have been removed and/or adjusted in the starter code accordingly.
